        ...
        <formaction="#" method="post">
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="cliente" placeholder="Informe o Cliente" name="pedido_cliente">
                </div>
                <div class="form-group col-md-4">
                    <label for="frete">Frete</label>
                    <input type="number" step="any" class="form-control" id="frete"  placeholder="Informe o Frete" min="0" onchange="calculaTotal();" name="pedido_frete">
                </div>
                <div class="form-group col-md-4">
                    <label for="met_pag">Método de Pagamento</label>
                    <select class="form-control" id="met_pag" name="met_pag">
                    ...
                    <formaction="#" method="post">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control" id="codigo" placeholder="Informe o Código" name="cod_jogo">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="quantidade">Quantidade</label>
                                <input type="number" class="form-control" id="quantidade" placeholder="Informe a Quantidade" name="qntd_jogo">
                            </div>
                        </div>
                    </form>
                </div>
